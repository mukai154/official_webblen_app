...
class _CreateRecurringEventPageState extends State<CreateRecurringEventPage> {
  ...
  showPickerDateTime(BuildContext context, String dateType) {
    Picker(
      adapter: new DateTimePickerAdapter(type: PickerDateTimeType.kHM_AP, strAMPM: ['AM', 'PM']),
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildDayOfSelectField() {
      return Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            recurrenceRadioVal != 0 ? Fonts().textW700("Every", 20.0, FlatColors.darkGray, TextAlign.left) : Container(),
            SizedBox(width: 8.0),
      ...
      child: ListView(
        children: <Widget>[
          Form(
            key: calendarFormKey,
            child: Column(
              children: <Widget>[_buildRecurrenceSelectField(), _buildDayOfSelectField(), _buildTimeFields(), formButton3],
            ),
          )
        ],
      ),
    ...
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: PageView(
            physics: NeverScrollableScrollPhysics(), controller: _pageController, children: [eventFormPage1, eventFormPage2, eventFormPage3, eventFormPage4]),
      ),
    );
  }
}
