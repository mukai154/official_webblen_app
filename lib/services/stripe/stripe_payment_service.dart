...
class StripePaymentService {
  CollectionReference stripeRef =
      FirebaseFirestore.instance.collection("stripe");
  ...
  Future<String> purchaseTickets(
    ...
    int ticketChargeInCents =
        int.parse((ticketCharge.toStringAsFixed(2)).replaceAll(".", ""));
    int totalChargeInCents =
        int.parse((totalCharge.toStringAsFixed(2)).replaceAll(".", ""));
...
//  }
  ...
  Future<Map<String, dynamic>> checkAccountVerificationStatus(
      String uid) async {
