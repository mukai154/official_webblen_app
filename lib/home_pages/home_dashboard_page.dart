          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  flex: 1,
                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, children: [widget.notifWidget]),
                ),
                Expanded(
                  flex: 1,
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.end, children: [widget.accountWidget]),
                ),
              ],
            ),
          ),
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            DiscoverTile(onTap: () => didPressDiscoverTile()),
                          ],
                        ),
                      ),
                      Padding(
