...
import 'package:webblen/calendar_pages/my_calendar_page.dart';
import 'package:webblen/calendar_pages/reminder_page.dart';
import 'package:webblen/chat_pages/chat_invite_share_page.dart';
import 'package:webblen/chat_pages/chat_page.dart';
import 'package:webblen/chat_pages/chats_index_page.dart';
import 'package:webblen/community_pages/choose_post_type_page.dart';
import 'package:webblen/community_pages/communities_in_area_page.dart';
...
import 'package:webblen/event_pages/create_edit_event_page.dart';
...
class PageTransitionService {
  ...
  void transitionToSim() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(simLocation: simLocation, simLat: simLat, simLon: simLon)));
  ...
  void transitionToUserSearchPage() => Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              UserSearchPage(currentUser: currentUser, userIDs: userIDs, userList: usersList, viewingMembersOrAttendees: viewingMembersOrAttendees)));

  //EVENTS
  void transitionToWebblenEventsPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => WebblenEventsFeedPage(currentUser: currentUser, events: events)));

  void transitionToCreateEditEventPage() => Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => CreateEditEventPage(currentUser: currentUser, community: community, isRecurring: isRecurring, eventToEdit: event)));

  void transitionToNewRecurringEventPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CreateRecurringEventPage(currentUser: currentUser, community: community)));
  ...
  void transitionToEventPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => EventDetailsPage(event: event, currentUser: currentUser, eventIsLive: eventIsLive)));

  void transitionToReccurringEventPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => RecurringEventDetailsPage(event: recurringEvent, currentUser: currentUser)));
  ...
  //CALENDAR
  void transitionToCalendarPage() => Navigator.push(context, MaterialPageRoute(builder: (context) => MyCalendarPage(currentUser: currentUser)));
  void transitionToReminderPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => ReminderPage(event: calendarEvent, currentUser: currentUser)));
  ...
  void transitionToRewardPayoutPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => RewardPayoutPage(redeemingReward: reward, currentUser: currentUser)));

  void transitionToTransactionHistoryPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => TransactionHistoryPage(currentUser: currentUser)));

  //USERS
  void transitionToUserRanksPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => UserRanksPage(simLocation: simLocation, simLat: simLat, simLon: simLon)));

  void transitionToFriendsPage() => Navigator.push(context, MaterialPageRoute(builder: (context) => FriendsPage(uid: uid)));

  void transitionToCurrentUserDetailsPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CurrentUserDetailsPage(currentUser: currentUser)));

  void transitionToUserDetailsPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => UserDetailsPage(currentUser: currentUser, webblenUser: webblenUser)));
  ...
  //CHATS
  void transitionToChatInviteSharePage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => ChatInviteSharePage(currentUser: currentUser, event: event)));

  void transitionToChatPage() => Navigator.push(context, MaterialPageRoute(builder: (context) => ChatPage(currentUser: currentUser, chatKey: chatKey)));

  void transitionToChatIndexPage() => Navigator.push(context, MaterialPageRoute(builder: (context) => ChatsIndexPage(currentUser: currentUser)));

  //COMMUNITIES
  void transitionToDiscoverPage() => Navigator.push(
      context, MaterialPageRoute(builder: (context) => DiscoverPage(uid: uid, areaName: areaName, simLocation: simLocation, simLat: simLat, simLon: simLon)));

  void transitionToMyCommunitiesPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => MyCommunitiesPage(uid: uid, action: action, areaName: areaName)));
  ...
  void transitionToChoosePostTypePage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => ChoosePostTypePage(currentUser: currentUser, community: community)));

  void transitionToPostCommentsPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CommunityPostCommentsPage(currentUser: currentUser, newsPost: newsPost)));

  void transitionToCommunityProfilePage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CommunityProfilePage(currentUser: currentUser, community: community)));

  void transitionToCommunityInvitePage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => InviteMembersPage(currentUser: currentUser, community: community)));

  void transitionToCommunityCreatePostPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CommunityCreatePostPage(currentUser: currentUser, community: community)));

  void transitionToComImagePage() => Navigator.push(context, MaterialPageRoute(builder: (context) => AddComImage(com: community)));

  void transitionToCommunitiesInAreaPage() => Navigator.push(context,
      MaterialPageRoute(builder: (context) => CommunitiesInAreaPage(currentUser: currentUser, action: action, areaName: areaName, communities: communities)));
  ...
  void transitionToCommunityRequestPage() => Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => CommunityRequestsPage(currentUser: currentUser, areaName: areaName, simLat: simLat, simLon: simLon, simLocation: simLocation)));

  void transitionToCommunityRequestDetailsPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CommunityRequestDetailsPage(request: comRequest, currentUser: currentUser)));

  void transitionToCreateCommunityRequestPage() =>
      Navigator.push(context, MaterialPageRoute(builder: (context) => CreateCommunityRequestPage(currentUser: currentUser, areaName: areaName)));

  //WEBBLEN SCANNER
  void openWebblenScanner() => Navigator.push(context, MaterialPageRoute(builder: (context) => WebblenScanner(currentUser: currentUser)));
}
