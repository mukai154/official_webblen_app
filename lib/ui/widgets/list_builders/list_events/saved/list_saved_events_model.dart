...
class ListSavedEventsModel extends ReactiveViewModel {
  ...
  loadData() async {
    ...
    dataResults = await _eventDataService.loadSavedEvents(
      id: user.id,
  ...
  loadAdditionalData() async {
    ...
    List<DocumentSnapshot> newResults = await _eventDataService.loadAdditionalSavedEvents(
      id: user.id,
