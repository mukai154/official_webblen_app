  ...
  showStripeAccountMenu() async {
    ...
    if (performInstantPayout) {
      if (userStripeInfo!.availableBalance == null || userStripeInfo!.availableBalance! < 5) {
        ...
        if (userStripeInfo!.userCardInfo == null) {
          _customDialogService.showErrorDialog(description: "Please Set Up a Payment Method for Instant Payouts");
        } else {
          ...
          if (status == "passed") {
            ...
            _customDialogService.showErrorDialog(
                description: "There may be an issue with your current payout method.\nIf this issue persists, please contact "
                    "team@webblen.com");
          }
        }
      }
