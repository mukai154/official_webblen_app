...
class RedeemedRewardsViewModel extends BaseViewModel {
  ...
  RedeemedRewardDataService? _redeemedRewardDataService = locator<RedeemedRewardDataService>();
  ...
  initialize(BuildContext context) async {
    ...
    WebblenUser currentUser = args['currentUser'] ?? "" as WebblenUser;
  ...
  loadRedeemedRewards(WebblenUser user) async {
    ...
    redeemedRewardResults = await _redeemedRewardDataService!.loadUserRedeemedRewards(
      uid: user.id,
  ...
  loadAdditionalRedeemedRewards(WebblenUser user) async {
    ...
    List<DocumentSnapshot> newResults = await _redeemedRewardDataService!.loadAdditionalUserRedeemedRewards(
      uid: user.id,
