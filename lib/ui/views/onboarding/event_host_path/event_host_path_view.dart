    ...
    return ViewModelBuilder<EventHostPathViewModel>.reactive(
      ...
      builder: (context, model, child) => Scaffold(
        body: IntroductionScreen(
          ...
          pages: [
            EventHostPathPages().initialEventHostPage(),
            EventHostPathPages().sellTicketsForFreePage(model),
            EventHostPathPages().createHostEarningsAccountPage(model),
...
class EventHostPathPages {
  ...
  PageViewModel initialEventHostPage() {
  ...
  PageViewModel sellTicketsForFreePage(EventHostPathViewModel model) {
    return PageViewModel(
  ...
  PageViewModel createHostEarningsAccountPage(EventHostPathViewModel model) {
    return PageViewModel(
