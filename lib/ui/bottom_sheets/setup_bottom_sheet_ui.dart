...
import 'package:webblen/ui/bottom_sheets/stripe_account_bottom_sheet/stripe_account_bottom_sheet.dart';
...
void setupBottomSheetUI() {
  ...
  final builders = {
    ...
    BottomSheetType.giftOrPurchaseWBLN: (context, sheetRequest, completer) => GiftWebblenBottomSheet(request: sheetRequest, completer: completer),
  };
