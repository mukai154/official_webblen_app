                      ...
                      widget.newsPost.userImageURL == null
                          ...
                          : Padding(
                              ...
                              child: UserDetailsProfilePic(
                                userPicUrl: widget.newsPost.userImageURL,
                                size: 50.0,
                              ),
                            ),
                      Padding(
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Fonts().textW300(
                      '${TimeCalc().getPastTimeFromMilliseconds(widget.newsPost.datePostedInMilliseconds)}',
                      12.0,
                      FlatColors.darkGray,
                      TextAlign.left,
                    ),
                          ...
                          child: Padding(
                            ...
                            child: Material(
                              ...
                              child: Padding(
                                ...
                                child: Fonts().textW400(
                                  '${widget.newsPost.areaName}/${widget.newsPost.communityName}',
                                  12.0,
                                  Colors.black,
                                  TextAlign.center,
                                ),
