...
class CommunityRequestRow extends StatelessWidget {
  ...
  CommunityRequestRow({
    this.request,
    this.transitionToComRequestDetails,
    this.upVoteAction,
    this.downVoteAction,
    this.uid,
  });
                        ...
                        Padding(
                          ...
                          child: Material(
                            ...
                            child: Padding(
                              ...
                              child: Fonts().textW400(
                                '${request.requestType == 'app' ? 'Webblen' : request.requestType}',
                                12.0,
                                Colors.black,
                                TextAlign.center,
                              ),
                            ...
                            child: Row(
                              children: <Widget>[
                                Fonts().textW500(
                                  ...
                                  16.0,
                                  request.upVotes.contains(uid)
                                      ? FlatColors.greenTeal
                                      : Colors.grey,
                                  TextAlign.right,
                                ),
                                SizedBox(
                                ...
                                Icon(
                                  ...
                                  color: request.upVotes.contains(uid)
                                      ? FlatColors.greenTeal
                                      : Colors.grey,
                                  size: 18.0,
                                ),
                        ...
                        Container(
                          child: GestureDetector(
                            ...
                            child: Row(
                              children: <Widget>[
                                Fonts().textW500(
                                  '${request.downVotes.length}',
                                  16.0,
                                  request.downVotes.contains(uid)
                                      ? Colors.red
                                      : Colors.grey,
                                  TextAlign.right,
                                ),
                                ...
                                Icon(
                                  ...
                                  color: request.downVotes.contains(uid)
                                      ? Colors.red
                                      : Colors.grey,
                                  size: 18.0,
                                ),
