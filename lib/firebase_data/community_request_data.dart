...
class CommunityRequestDataService {
  final CollectionReference comRequestRef =
      Firestore.instance.collection("community_requests");
  ...
  Future<List<CommunityRequest>> getComRequests(String areaName) async {
    ...
    final HttpsCallable callable = CloudFunctions.instance.getHttpsCallable(
      functionName: 'getCommunityRequests',
    );
  ...
  Future<String> updateVoting(
      String reqID, List upVotes, List downVotes) async {
    String error = '';
    await comRequestRef
        .document(reqID)
        .updateData({
