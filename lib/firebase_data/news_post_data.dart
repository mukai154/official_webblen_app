...
class NewsPostDataService {
  final CollectionReference newsPostRef =
  ...
  Future<List<CommunityNewsPost>> getCommunityNewsPosts(
      String areaName, String comName) async {
    List<CommunityNewsPost> posts = [];
    final HttpsCallable callable = CloudFunctions.instance.getHttpsCallable(
      functionName: 'getCommunityNewsPosts',
    );
  ...
  Future<List<CommunityNewsPost>> getUserNewsPostFeed(
      Map<dynamic, dynamic> userComs) async {
    List<CommunityNewsPost> posts = [];
    final HttpsCallable callable = CloudFunctions.instance.getHttpsCallable(
      functionName: 'getUserNewsPostFeed',
    );
    final HttpsCallableResult result = await callable.call(
      <String, dynamic>{
        'userComs': userComs,
