...
class _DigitalEventPageState extends State<DigitalEventPage> {
  ...
  Widget build(BuildContext context) {
    SchedulerBinding.instance
        .addPostFrameCallback((_) => scrollToChatMessage());
    Widget eventChat() {
      return StreamBuilder(
        stream: Firestore.instance
            ...
            .collection("messages")
            .where('timePostedInMilliseconds',
                isGreaterThan: startChatAfterTimeInMilliseconds - 300000)
        ...
        child: Stack(
          children: <Widget>[
            ...
            Container(
              ...
              padding:
                  EdgeInsets.only(top: 50, left: 16, right: 16, bottom: 16.0),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Container(
