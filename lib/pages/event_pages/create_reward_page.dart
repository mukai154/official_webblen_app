...
class _CreateRewardPageState extends State<CreateRewardPage> {
  ...
  final rewardFormKey = GlobalKey<FormState>();
  ...
  void validateReward() {
    ...
    if (rewardProviderName.isEmpty) {
      ...
      scaffold.showSnackBar(
        SnackBar(
          content: Text(
            "Reward Must be Worth At Least 10 pts",
          ),
          backgroundColor: Colors.red,
          duration: Duration(
            milliseconds: 800,
        ...
        RaisedButton(
          ...
          onPressed: () async {
            ...
            PlacesDetailsResponse detail =
                await GoogleMapsPlaces().getDetailsByPlaceId(p.placeId);
            setState(() {
          ...
          child: Text(
            rewardAddress == null ? "Set Location" : "$rewardAddress",
          ),
        ),
      ],
    );
