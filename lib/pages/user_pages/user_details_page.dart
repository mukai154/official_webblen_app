...
class _UserDetailsPageState extends State<UserDetailsPage>
  ...
  Future<void> loadUserData() async {
    events =
        await EventDataService().getUserEventHistory(widget.webblenUser.uid);
    events.sort((e1, e2) =>
        e2.startDateInMilliseconds.compareTo(e1.startDateInMilliseconds));
    communities =
        await CommunityDataService().getUserCommunities(widget.webblenUser.uid);
  ...
  Future<void> getUserCommunities() async {
    ...
    await CommunityDataService()
        .getUserCommunities(widget.webblenUser.uid)
        .then((result) {
      ...
      if (error.isEmpty) {
        ShowAlertDialogService().showSuccessDialog(
          ...
          "@" +
              ...
              " Will Need to Confirm Your Request",
        );
        friendRequestStatus = "pending";
        setState(() {});
      } else {
        ShowAlertDialogService()
            .showFailureDialog(context, "Request Failed", error);
      }
    });
  }
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Container(
                      ...
                      child: UserDetailsHeader(
                        ...
                        eventHistoryCount:
                            widget.webblenUser.eventHistory.length.toString(),
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Container(
                      ...
                      child: UserDetailsHeader(
                        ...
                        eventHistoryCount:
                            widget.currentUser.eventHistory.length.toString(),
                        communityCount: communities.length.toString(),
                        viewFriendsAction: null,
                        addFriendAction: null,
