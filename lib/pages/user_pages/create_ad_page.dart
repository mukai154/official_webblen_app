...
class _CreateAdPageState extends State<CreateAdPage> {
  ...
  void validateAndSubmit() async {
    ...
    if (currentLat == null) {
      AlertFlushbar(
        headerText: "Error",
        bodyText: "There was an issue finding your location. Please try again.",
      ).showAlertFlushbar(context);
    } else if (localAd.adURL == null || localAd.adURL.isEmpty) {
      AlertFlushbar(
        headerText: "Error",
        bodyText: "Ad Needs a URL",
      ).showAlertFlushbar(context);
    } else {
      ...
      if (urlIsValid) {
        ...
        localAd.datePostedInMilliseconds =
        ...
        AdDataService()
          ...
          if (error.isEmpty) {
            ...
            ShowAlertDialogService().showFailureDialog(
              context,
              'Uh Oh',
              'There was an issue uploading your ad. Please try again.',
            );
          }
        });
      } else {
