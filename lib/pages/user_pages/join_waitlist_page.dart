...
class _JoinWaitlistPageState extends State<JoinWaitlistPage> {
  ...
  var phoneMaskController = MaskedTextController(
    mask: '+0 000-000-0000',
  );
  String phoneNo;
  String zipCode;
    ...
    if (validateAndSave()) {
      if (email == null && phoneNo == null) {
        ...
        ShowAlertDialogService().showFailureDialog(
          context,
          "Info Missing",
          "Please Enter Your Email or Phone Number to Join Our Waitlist",
        );
        ...
        ShowAlertDialogService().showFailureDialog(
          context,
          "Location Missing",
          "Please Enable Location Services to Join Our Waitlist",
        );
      } else {
        UserDataService()
            .joinWaitList(
