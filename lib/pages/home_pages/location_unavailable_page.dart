      ...
      child: Column(
        ...
        children: <Widget>[
          currentUser.isOnWaitList
              ...
              : Fonts().textW700(
                  "It Looks Like Webblen Isn't In Your Area Yet 😥",
                  24.0,
                  FlatColors.darkGray,
                  TextAlign.center,
                ),
          ...
          currentUser.isOnWaitList
              ? Fonts().textW500(
                  "We'll Notify You When We're Around. Don't You Worry 😉",
                  14.0,
                  FlatColors.darkGray,
                  TextAlign.center,
                )
              : Fonts().textW500(
                  "Join our Waitlist and We'll Notify You When We're Around",
                  14.0,
                  FlatColors.darkGray,
                  TextAlign.center,
                ),
