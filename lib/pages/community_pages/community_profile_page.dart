...
class _CommunityProfilePageState extends State<CommunityProfilePage>
  ...
  Future<Null> getUpcomingCommunityEvents(bool reloadingData) async {
    ...
    await CommunityDataService()
      ...
      upcomingEvents.sort((eventA, eventB) => eventA.startDateInMilliseconds
  ...
  Future<Null> getCommunityNewsPosts(bool reloadingData) async {
    ...
    await NewsPostDataService()
      ...
      widget.community.name,
        ...
        .then((result) {
      posts = result;
      posts.sort((postA, postB) => postB.datePostedInMilliseconds
    ...
    if (eventExists) {
      if (eventType == 'upcoming') {
        ...
        PageTransitionService(
          ...
          currentUser: widget.currentUser,
        ).transitionToReccurringEventPage();
      }
    } else {
      ShowAlertDialogService().showFailureDialog(
        context,
        "Woops!",
        'It looks like this event no longer exists',
      );
      if (eventType == 'upcoming') {
  ...
  addEventAction() {
    ...
    ).transitionToChoosePostTypePage();
  }
          ...
          children: <Widget>[
            Container(
              ...
              child: isLoading
                  ? LoadingScreen(
                      context: context,
                      loadingDescription: 'Loading Upcoming Events...',
                    )
                  : LiquidPullToRefresh(
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ComEventRow(
                                  ...
                                  shareEventAction: () => PageTransitionService(
                                    context: context,
                                    currentUser: widget.currentUser,
                                    event: upcomingEvents[index],
                                  ).transitionToChatInviteSharePage(),
                                  eventPostAction: () => eventPostAction(
            ...
            Container(
              ...
              child: isLoading
                  ? LoadingScreen(
                      context: context,
                      loadingDescription: 'Loading Regular Events...',
                    )
                  : LiquidPullToRefresh(
                      color: FlatColors.webblenRed,
