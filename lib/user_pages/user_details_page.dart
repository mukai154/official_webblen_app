...
class _UserDetailsPageState extends State<UserDetailsPage> with SingleTickerProviderStateMixin {
  ...
  Future<Null> deleteFriendConfirmation() async {
    ...
    ShowAlertDialogService().showConfirmationDialog(context, "Are You Sure You Want to no longer be friends with @${widget.webblenUser.username}?",
        "Remove Friend", () => removeFriend(), () => Navigator.of(context).pop());
  }
  ...
  void messageUser() {
    ShowAlertDialogService().showLoadingDialog(context);
    ChatDataService().checkIfChatExists([widget.currentUser.uid, widget.webblenUser.uid]).then((chatKey) {
      if (chatKey != null && chatKey.isNotEmpty) {
        Navigator.of(context).pop();
        Navigator.of(context).pop();
        transitionToMessenger(chatKey);
      } else {
        ChatDataService().createChat(widget.currentUser.uid, [widget.currentUser.uid, widget.webblenUser.uid]).then((chatKey) {
          Navigator.of(context).pop();
          Navigator.of(context).pop();
          transitionToMessenger(chatKey);
        });
            ...
            headerSliverBuilder: (BuildContext context, bool boxIsScrolled) {
              return <Widget>[
                SliverAppBar(
                  ...
                  title: Fonts().textW700("People", 24.0, Colors.black, TextAlign.center),
                  pinned: true,
                  floating: true,
                  snap: false,
                  ...
                  actions: <Widget>[
                    IconButton(
                      icon: Icon(FontAwesomeIcons.ellipsisH, size: 24.0, color: Colors.black),
              ...
              children: <Widget>[
                    ...
                    child: isLoading
                        ? ListView(
                            children: <Widget>[
                              ...
                              Fonts().textW500('Loading Communities...', 14.0, Colors.black45, TextAlign.center),
                            ],
                          )
                        : communities.isEmpty
                            ? ListView(
                            ...
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return CommunityRow(
                                    ...
                                    onClickAction: () => PageTransitionService(context: context, currentUser: widget.currentUser, community: communities[index])
                ...
                isLoading
                    ? ListView(
                        children: <Widget>[
                          SizedBox(height: 64.0),
                          Fonts().textW500('Loading Events...', 14.0, Colors.black45, TextAlign.center),
                        ],
                      )
            ...
            headerSliverBuilder: (BuildContext context, bool boxIsScrolled) {
              return <Widget>[
                SliverAppBar(
                  brightness: Brightness.light,
                  backgroundColor: Colors.white,
                  title: Fonts().textW700("My Account", 24.0, Colors.black, TextAlign.center),
                  pinned: true,
                  floating: true,
                  snap: true,
                  leading: BackButton(color: Colors.black),
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return CommunityRow(
                                      ...
                                      community: communities[index],
                                      onClickAction: () =>
                                          PageTransitionService(context: context, currentUser: widget.currentUser, community: communities[index])
                                              .transitionToCommunityProfilePage(),
                                    );
                                  },
                                ),
                              ...
                              : ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return ComEventRow(
                                        ...
                                        currentUser: widget.currentUser,
                                        eventPostAction: () =>
                                            PageTransitionService(context: context, currentUser: widget.currentUser, event: events[index], eventIsLive: false)
