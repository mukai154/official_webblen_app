...
GetIt $initGetIt(
  ...
  gh.lazySingleton<AlgoliaSearchService>(() => servicesModule.algoliaSearchService);
  ...
  gh.lazySingleton<FirestoreStorageService>(() => servicesModule.firestoreStorageService);
  gh.lazySingleton<GooglePlacesService>(() => servicesModule.googlePlacesService);
  ...
  gh.lazySingleton<NotificationDataService>(() => servicesModule.notificationDataService);
  gh.lazySingleton<PlatformDataService>(() => servicesModule.platformDataService);
  gh.lazySingleton<PostDataService>(() => servicesModule.postDataService);
  gh.lazySingleton<RedeemedRewardDataService>(() => servicesModule.redeemedRewardDataService);
  gh.lazySingleton<ShareService>(() => servicesModule.shareService);
  gh.lazySingleton<SnackbarService>(() => servicesModule.snackBarService);
  gh.lazySingleton<StripeConnectAccountService>(() => servicesModule.stripeConnectAccountService);
  gh.lazySingleton<StripePaymentService>(() => servicesModule.stripePaymentService);
  gh.lazySingleton<ThemeService>(() => servicesModule.themeService);
  gh.lazySingleton<TicketDistroDataService>(() => servicesModule.ticketDistroDataService);
  ...
  gh.singleton<WebblenBaseViewModel>(WebblenBaseViewModel());
...
class _$ServicesModule extends ServicesModule {
  ...
  @override
  FirestoreStorageService get firestoreStorageService => FirestoreStorageService();
  @override
  ...
  @override
  NotificationDataService get notificationDataService => NotificationDataService();
  @override
  PlatformDataService get platformDataService => PlatformDataService();
  @override
  PostDataService get postDataService => PostDataService();
  @override
  RedeemedRewardDataService get redeemedRewardDataService => RedeemedRewardDataService();
  @override
  ShareService get shareService => ShareService();
  @override
  SnackbarService get snackBarService => SnackbarService();
  @override
  StripeConnectAccountService get stripeConnectAccountService => StripeConnectAccountService();
  @override
  StripePaymentService get stripePaymentService => StripePaymentService();
  @override
  TicketDistroDataService get ticketDistroDataService => TicketDistroDataService();
  @override
