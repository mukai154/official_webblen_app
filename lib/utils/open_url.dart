...
class OpenUrl {
  ...
  openMaps(BuildContext context, String lat, String lon) async {
    ...
    if (await canLaunch(mapURL)) {
      ...
      ShowAlertDialogService().showFailureDialog(context, "Map Error", "There was an issue launching maps");
    }
  }
 ...
 launchInWebViewOrVC(BuildContext context, String url) async {
    if (await canLaunch(url)) {
      ...
      ShowAlertDialogService().showFailureDialog(context, "URL Error", "There was an issue launching this url");
    }
  }
