...
class UserDrawerMenu {
  ...
  Widget menuRow(Icon icon, String optionName, Color optionColor, VoidCallback onTap) {
    return ListTile(
      leading: Container(
        constraints: BoxConstraints(maxHeight: 40.0, maxWidth: 200.0),
        child: Row(
          children: <Widget>[
            Padding(
          ...
          : ListView(
              children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  IconButton(
                                    icon: Icon(FontAwesomeIcons.qrcode, color: Colors.black, size: 24.0),
                                    onPressed: () {
                                      ShowAlertDialogService().showAccountQRDialog(context, currentUser.username, currentUser.uid,
                                          () => PageTransitionService(context: context, currentUser: currentUser).openWebblenScanner());
                                    },
                                  ),
                                ],
                              ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  ShowAmountOfWebblen(
                                      amount: currentUser.eventPoints.toStringAsFixed(2), textColor: Colors.black, textSize: 14.0, iconSize: 24.0, onTap: null),
                                ],
                              ),
                            ),
                          ],
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    PageTransitionService(context: context, currentUser: currentUser).transitionToChatIndexPage();
                  },
                ),
                menuRow(
                  Icon(FontAwesomeIcons.calendar, color: FlatColors.blackPearl, size: 18.0),
                  'Calendar',
                  FlatColors.blackPearl,
                  () {
                    Navigator.pop(context);
                    PageTransitionService(context: context, currentUser: currentUser).transitionToCalendarPage();
                  },
                ),
                menuRow(
